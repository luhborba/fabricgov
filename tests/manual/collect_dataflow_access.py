...
print("="*70)
print("COLETA DE ACESSOS EM DATAFLOWS")
print("="*70)
...
try:
    ...
    print("="*70)
    print(f"Total de acessos coletados: {len(result['dataflow_access'])}")
    print(f"Erros: {len(result['dataflow_access_errors'])}")
    print("="*70)
    ...
    print("="*70)
    print(f"⏹️  {e.progress} dataflows processados")
