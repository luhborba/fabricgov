...
print("="*70)
print("COLETA DE ACESSOS EM REPORTS")
print("="*70)
...
try:
    ...
    print("="*70)
    print(f"Total de acessos coletados: {len(result['report_access'])}")
    print(f"Erros: {len(result['report_access_errors'])}")
    print("="*70)
    ...
    print("="*70)
    print(f"⏹️  {e.progress} reports processados")
