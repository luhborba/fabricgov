...
from fabricgov.collectors import WorkspaceAccessCollector
...
print("="*70)
print("COLETA DE ACESSOS EM WORKSPACES")
print("="*70)
...
try:
    ...
    print("="*70)
    print(f"Total de acessos coletados: {len(result['workspace_access'])}")
    print(f"Erros: {len(result['workspace_access_errors'])}")
    print("="*70)
    ...
    print("="*70)
    print(f"⏹️  {e.progress} workspaces processados")
